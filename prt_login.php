...
<form action="" method="post">
 <h2>LOGIN PAGE</h2>
  <div class="container">
    <center><label for="uname"><b>Parent's ID</b></label><br>
    <input type="text" placeholder="Enter Parent's ID" name="guardian_num" required></center><br>

    <center><label for="psw"><b>Password</b></label><br>
    <input type="password" placeholder="Enter Password" name="prt_password" required></center><br>
	...
	<center> <a href="register2.php">Not register yet?</a></center>
...
<?php
		...
		if(isset($_POST['submit'])){
			...
			$_SESSION['guardian_num'] = $_POST['guardian_num'];
			$_SESSION['prt_password'] = $_POST['prt_password'];
			
			include ('connectdb.php');
			
			$sql = "SELECT * FROM parents WHERE guardian_num = '".$_SESSION['guardian_num']."' AND prt_password='".$_SESSION['prt_password']."'";
			...
			while ($row=mysqli_fetch_array($result))
			{
				if (row == TRUE) {
					...
					echo 'window.location.href="prt_home.php";';
					echo '</script>';
