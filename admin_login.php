...
<form action="" method="post">
 <h2>LOGIN PAGE</h2>
  <div class="container">
    <center><b>Staff ID</b><br>
    <input type="text" placeholder="Enter Staff ID" name="staff_id" required></center><br>

    <center><b>Password</b><br>
    <input type="password" placeholder="Enter Password" name="password" required></center><br>
        
    <center><button type="submit" class="submit" name="submit">Login</button></center>
...
<?php
		...
		if(isset($_POST['submit'])){
			...
			$sql = "SELECT * FROM warden WHERE staff_id = '".$_SESSION['staff_id']."' AND password='".$_SESSION['password']."'";
