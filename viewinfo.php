...
<table width="100%" cellpadding="3" cellspacing="5"  bgcolor="#006699">
	<tr>
    <ul>
  <li><a href="std_home.php"><strong>HOME</strong></a></li>
  <li><a href="viewinfo.php"><strong>INFORMATION</strong></a></li>
  <li><a href="displaydata.php"><strong>STATUS</strong></a></li>
</ul>
...
<center><p class="round2"><br>Student ID : &nbsp;&nbsp;
...
//$sql = "SELECT * FROM parents, students WHERE student_id = '$search'"; 
//$sql = "SELECT * FROM students, parents WHERE guardian_num = '$search' AND students.guardian_num = parents.guardian_num"; 
$sql = "SELECT * FROM students, parents WHERE students.student_id LIKE '$search' AND students.guardian_num = parents.guardian_num"; 
